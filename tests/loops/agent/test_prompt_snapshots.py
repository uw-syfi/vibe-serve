...
def test_llm_serving_rendered_prompts_keep_required_domain_content():
    ...
    assert "full traceback" in normalized_prompts["implementer"]
    assert "last completed named substage" in normalized_prompts["implementer"]
    assert "paid repair guess" in normalized_prompts["judge"]
