...
hang. Checkpoints accumulated only in remote memory and returned at completion
are not live or durable; require external visibility while the phase runs.
Smoke must traverse the newly changed failure-prone path (including its
