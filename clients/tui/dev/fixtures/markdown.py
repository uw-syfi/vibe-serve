...
def event(  # noqa: PLR0913
    ...
    *,
    ...
    return {
        ...
        "invocation_id": None if agent_kind is None else "inv-1",
        "execution_id": None if agent_kind is None else "inv-1",
        "chat_thread_id": None,
        "data": data,
    }
...
def build() -> list[dict]:
    ...
    events.extend(
        [
            ...
            event(sequence + 2, offset + 600, "run_finished", status="completed"),
        ]
    )
    return events
