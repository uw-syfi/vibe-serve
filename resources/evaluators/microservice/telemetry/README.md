...
The DeathStarBench repository example is the reference wiring. See
`.vibesys/tasks/hotel-reservation/vibesys.input.toml` and
`.vibesys/tasks/hotel-reservation/benchmark/otel/telemetry.toml` in
